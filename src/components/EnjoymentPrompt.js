    ...
    return (
      <div className="mb-8 rounded-xl border border-orange-500/30 bg-zinc-900 p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <p className="text-sm font-medium text-orange-400">Quick check-in</p>
        </div>
        <h3 className="text-lg font-bold">Are you enjoying Stride & Steel?</h3>
    ...
    <div className="mb-8 rounded-xl border border-orange-500/30 bg-zinc-900 p-6">
      ...
      <div className="mt-4 flex items-center gap-2">
        ...
        <button
          ...
          className="shrink-0 rounded-lg bg-orange-500 px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-orange-600"
        >
