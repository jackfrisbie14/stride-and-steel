...
const SEGMENTS = [
  { label: "10% OFF", discount: 10, color: "#f97316" },
  { label: "20% OFF", discount: 20, color: "#ea580c" },
  { label: "30% OFF", discount: 30, color: "#f97316" },
  { label: "40% OFF", discount: 40, color: "#ea580c" },
  { label: "50% OFF", discount: 50, color: "#f97316" },
  { label: "60% OFF", discount: 60, color: "#ea580c" },
];
          ...
          <button
            ...
            className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 rounded-full font-bold text-sm transition-all ${
              isSpinning
                ...
                : "bg-white text-orange-500 hover:scale-105 shadow-lg cursor-pointer"
            }`}
          >
