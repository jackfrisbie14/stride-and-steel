          ...
          {step === "customize_prompt" && (
            <div className="text-center">
              ...
              <p className="text-sm text-zinc-400 mb-4">
                You can adjust your training days, lifting split, experience level, and favorite exercises to get workouts that fit you better.
              </p>
          ...
          {step === "offer" && (
            <div className="text-center">
              ...
              <p className="text-zinc-400 mb-4">
                We'd hate to see you go. How about <span className="text-orange-400 font-bold">{RETURN_OFFER_DISCOUNT}% off</span> your next month?
              </p>
