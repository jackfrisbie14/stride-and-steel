...
function RaceCountdown({ raceDate, raceName }) {
  ...
  return (
    <div className="flex items-center justify-center gap-4">
      <div className="text-center">
        <p className="text-3xl font-bold text-orange-500">{timeLeft.weeks}</p>
        <p className="text-xs text-zinc-500">weeks</p>
      </div>
      <div className="text-center">
        <p className="text-3xl font-bold text-orange-400">{timeLeft.remainingDays}</p>
...
export default function RaceGoal({ initialRaceGoal, racePlanActive, racePlanInfo }) {
  ...
  if (generatingPlan) {
    return (
      <div className="mb-8 rounded-xl border border-orange-500/30 bg-gradient-to-br from-orange-500/10 to-zinc-900 p-8 text-center">
  ...
  if (isEditing) {
    return (
      <div className="mb-8 rounded-xl border border-orange-500/30 bg-zinc-900 p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              ...
              className="flex-1 py-3 rounded-xl bg-orange-500 font-semibold text-white hover:bg-orange-600 transition-colors disabled:opacity-50"
            >
  ...
  // Display race goal
  return (
    <div className="mb-8 rounded-xl border border-orange-500/30 bg-gradient-to-br from-orange-500/10 to-zinc-900 p-6">
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-2">
          <span className="text-2xl">🏁</span>
          <div>
            <p className="text-sm text-orange-400">Your Race Goal</p>
      ...
      {racePlanActive && racePlanInfo && (
        <div className="mb-4 p-3 rounded-lg bg-zinc-800/50 border border-zinc-700">
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="px-2 py-0.5 rounded-full text-xs font-medium bg-orange-500/20 text-orange-400 capitalize">
