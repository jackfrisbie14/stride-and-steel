            ...
            <>
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  ...
                  className="flex-1 py-3 rounded-xl bg-orange-500 font-semibold text-white hover:bg-orange-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
            ...
            <>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full h-20 rounded-lg bg-zinc-800 px-4 py-3 text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-orange-500 resize-none"
                />
              </div>
