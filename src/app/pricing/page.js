            ...
            {!showReferralInput ? (
              ...
              <div className="rounded-lg border border-zinc-800 bg-zinc-900 p-4">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-zinc-700 bg-zinc-800 px-4 py-2.5 text-sm text-zinc-200 placeholder-zinc-600 focus:border-orange-500 focus:outline-none"
                />
                {referralCode && (
