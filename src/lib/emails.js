  ...
  drip_1hr: (user) => ({
    ...
    html: layout(
      `<h1 style="color:#ffffff;font-size:22px;margin:0 0 16px;">Your plan is waiting for you</h1>
       ...
       <p style="color:#d4d4d8;font-size:15px;line-height:1.6;margin:0 0 16px;">
         We just built you a personalized training plan based on your <strong style="color:#f97316;">${user.archetype || "Hybrid Athlete"}</strong> profile. It's sitting in your dashboard right now — workouts tailored to your goals, your schedule, and your experience level.
       </p>
       <p style="color:#d4d4d8;font-size:15px;line-height:1.6;margin:0 0 16px;">
  ...
  drip_24hr: (user) => ({
    ...
    html: layout(
      `<h1 style="color:#ffffff;font-size:22px;margin:0 0 16px;">What's your training actually costing you?</h1>
       ...
       <p style="color:#d4d4d8;font-size:15px;line-height:1.6;margin:0 0 16px;">
         Your <strong style="color:#f97316;">${user.archetype || "Hybrid Athlete"}</strong> plan combines running programming and strength training into one cohesive system — the kind of thing you'd normally need two coaches for.
       </p>
       <p style="color:#d4d4d8;font-size:15px;line-height:1.6;margin:0 0 16px;">
  ...
  drip_72hr: (user) => ({
    ...
    html: layout(
      `<h1 style="color:#ffffff;font-size:22px;margin:0 0 16px;">Your plan won't wait forever</h1>
       <p style="color:#d4d4d8;font-size:15px;line-height:1.6;margin:0 0 16px;">
         ${user.name ? `${user.name}, we` : "We"} built a training plan specifically for your <strong style="color:#f97316;">${user.archetype || "Hybrid Athlete"}</strong> profile — your goals, your schedule, your experience level.
       </p>
       <p style="color:#d4d4d8;font-size:15px;line-height:1.6;margin:0 0 16px;">
